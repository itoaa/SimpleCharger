...
INT8U MCP_CAN::mcp2515_init(const INT8U canIDMode, const INT8U canSpeed, const INT8U canClock)
{
  ...
  INT8U res;
    ...
    {
#if DEBUG_MODE
      puts("Entering Configuration Mode Failure...");
#endif
      return res;
    }
#if DEBUG_MODE
    puts("Entering Configuration Mode Successful!");
#endif
    ...
    {
#if DEBUG_MODE
      puts("Setting Baudrate Failure...\r\n");
#endif
      return res;
    }
#if DEBUG_MODE
    puts("Setting Baudrate Successful!\r\n");
#endif
...
*/
        ...
        {
#if DEBUG_MODE
          puts("Returning to Previous Mode Failure...\r\n");
#endif
          return res;
        }
...
*********************************************************************************************************/
MCP_CAN::MCP_CAN(INT8U _CS) // _CS must match AVR name of pin, Not Arduino name.
{
    MCPCS = _CS;
...
INT8U MCP_CAN::init_Mask(INT8U num, INT8U ext, INT32U ulData)
{
  ...
  return res;
    ...
    if(res > 0){
#if DEBUG_MODE
    puts("Entering Previous Mode Failure...\r\nSetting Mask Failure...\r\n");
#endif
    return res;
  }
#if DEBUG_MODE
    puts("Setting Mask Successful!\r\n");
#endif
    return res;
}
...
INT8U MCP_CAN::init_Filt(INT8U num, INT8U ext, INT32U ulData)
{
    INT8U res = MCP2515_OK;
#if DEBUG_MODE
    puts("Starting to Set Filter!\r\n");
#endif
    res = mcp2515_setCANCTRL_Mode(MODE_CONFIG);
    if(res > 0)
    {
#if DEBUG_MODE
      puts("Enter Configuration Mode Failure...\r\n");
#endif
      return res;
    }
...
#if DEBUG_MODE
    puts("Setting Filter Successfull!\r\n");
#endif
